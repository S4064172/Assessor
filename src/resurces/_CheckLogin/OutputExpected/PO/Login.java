...
public class Login {
    ...
    public String checkCorrectPage() {
        By elem = By.cssSelector(".card-title");
        MyUtils.WaitForElementLoaded(driver, elem);
        return driver.findElement(elem).getText();
    }

    public void set_username(String key1) {
    ...
    public void set_password(String key2) {
    ...
    public void click_Login() {
        By elem = By.name("Login");
        MyUtils.WaitForElementLoaded(driver, elem);
        driver.findElement(elem).click();
    }

    public void setCredential(String key1, String key2) {
        set_username(key1);
        set_password(key2);
        click_Login();
    }
